...
module.exports = defineConfig([
  expoConfig,
  {
    ignores: [
      "dist/*",
      ".github/**",
      // Storybook template files generated by sb-rn-get-stories include
      // react-native <Text> and color literals that violate Dayline lint rules.
      // We keep our custom Dayline stories linted.
      ".rnstorybook/stories/Button.*",
      ".rnstorybook/stories/Button.stories.*",
      ".rnstorybook/stories/Header.*",
      ".rnstorybook/stories/Header.stories.*",
      ".rnstorybook/stories/Page.*",
      ".rnstorybook/stories/Page.stories.*",
          ...
          patterns: [
            {
              group: ["**/__mocks__/**"],
              message:
                "No importes mocks en runtime. Poné la data mock en __mocks__/ y usala solo desde tests o Storybook.",
            },
          ],
        },
      ],
      ...
      "import/no-internal-modules": [
        "error",
        {
          allow: [
            ...
            "@/features/*/hooks", // Permitir barrel de hooks (index.ts)
            "@/features/*/services/**", // Permitir services dentro de features
            "@/features/*/logic/**", // Permitir logic dentro de features
            "@/features/*/logic", // Permitir barrel de logic (index.ts)
            "@/features/*/types/**", // Permitir types dentro de features
            "@/features/*/types", // Permitir barrel de types (index.ts)
            "@/features/*/utils/**", // Permitir utils dentro de features
            "@/features/*/__mocks__/**", // Permitir mocks dentro de features
            "@/types/**", // Permitir types en src/types/
            "@/__mocks__/**", // Permitir mocks en src/__mocks__/
  ...
  // Override para logic layer: permitir imports de mocks (encapsula fuentes de datos)
  {
    files: ["src/features/*/logic/**/*.ts", "src/features/*/logic/**/*.tsx"],
    rules: {
      "no-restricted-imports": "off",
      "import/no-internal-modules": "off",
    },
